...
import { IcChip, IcBadge, IcTypography } from "../components";
...
<Canvas>
  <Story name="Static">
    <IcChip label="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris sit amet lectus eget sem tincidunt tristique. Vestibulum nec est eu metus dapibus elementum. Cras auctor neque et dolor placerat feugiat. Nulla facilisi. Sed sit amet euismod nunc. Morbi in sem tellus. Mauris ac pellentesque eros. Mauris volutpat dapibus turpis, venenatis tincidunt urna scelerisque sed. Pellentesque eleifend nibh eu tellus congue, a iaculis elit interdum. Duis ornare tortor nunc.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris sit amet lectus eget sem tincidunt tristique. Vestibulum nec est eu metus dapibus elementum. Cras auctor neque et dolor placerat feugiat. Nulla facilisi. Sed sit amet euismod nunc. Morbi in sem tellus. Mauris ac pellentesque eros. Mauris volutpat dapibus turpis, venenatis tincidunt urna scelerisque sed. Pellentesque eleifend nibh eu tellus congue, a iaculis elit interdum. Duis ornare tortor nunc." maxLines="3" size="small">
      <svg
        slot="icon"
        width="20"
        height="20"
...
export const AGGrid = () => {
  ...
  const colDefs = [
    { field: "firstName" },
    { field: "lastName" },
    { field: "jobTitle", cellRenderer: JobTitleRenderer, cellStyle: { overflow: "visible" } },
  ];
